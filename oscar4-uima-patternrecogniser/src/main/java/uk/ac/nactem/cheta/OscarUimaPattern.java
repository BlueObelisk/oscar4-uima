...
public class OscarUimaPattern extends JTextAnnotator_ImplBase {
	private   PatternRecogniser patternRecogniser;
	ProcessingDocument procDoc = null;
	java.util.List<NamedEntity> Entities;
	String localNE;
	private static final Logger LOG = Logger.getLogger(OscarUimaPattern.class);


	public OscarUimaPattern(){
		patternRecogniser = new PatternRecogniser();
	}
