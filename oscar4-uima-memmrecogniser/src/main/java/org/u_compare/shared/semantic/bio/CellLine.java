 ...
 * @generated */
public class CellLine extends NamedEntity {
  /** @generated
   * @ordered 
   */
  public final static int typeIndexID = JCasRegistry.register(CellLine.class);
  /** @generated
   * @ordered 
   */
   ...
   * @generated */
  public CellLine(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  
  /** @generated */
  public CellLine(JCas jcas) {
    super(jcas);
    readObject();   
  } 

  /** @generated */  
  public CellLine(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
