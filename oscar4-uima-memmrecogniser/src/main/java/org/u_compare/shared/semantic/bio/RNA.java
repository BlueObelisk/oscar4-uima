 ...
 * @generated */
public class RNA extends NamedEntity {
  /** @generated
   * @ordered 
   */
  public final static int typeIndexID = JCasRegistry.register(RNA.class);
  /** @generated
   * @ordered 
   */
   ...
   * @generated */
  public RNA(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  
  /** @generated */
  public RNA(JCas jcas) {
    super(jcas);
    readObject();   
  } 

  /** @generated */  
  public RNA(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
