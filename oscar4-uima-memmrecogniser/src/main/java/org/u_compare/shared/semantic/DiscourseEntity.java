 ...
 * @generated */
public class DiscourseEntity extends SemanticClassAnnotation {
  /** @generated
   * @ordered 
   */
  public final static int typeIndexID = JCasRegistry.register(DiscourseEntity.class);
  /** @generated
   * @ordered 
   */
   ...
   * @generated */
  public DiscourseEntity(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  /** @generated */  
  public DiscourseEntity(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
