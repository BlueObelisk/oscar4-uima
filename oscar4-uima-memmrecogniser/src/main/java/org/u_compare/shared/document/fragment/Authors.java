...
public class Authors extends Fragment {
   ...
   * @ordered 
   */
  public final static int typeIndexID = JCasRegistry.register(Authors.class);
  /** @generated
   * @ordered 
   */
   ...
   * @generated */
  public Authors(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  
  /** @generated */
  public Authors(JCas jcas) {
    super(jcas);
    readObject();   
  } 

  /** @generated */  
  public Authors(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
