 ...
 * @generated */
public class Appendix extends Structure {
  /** @generated
   * @ordered 
   */
  public final static int typeIndexID = JCasRegistry.register(Appendix.class);
  /** @generated
   * @ordered 
   */
   ...
   * @generated */
  public Appendix(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  
  /** @generated */
  public Appendix(JCas jcas) {
    super(jcas);
    readObject();   
  } 

  /** @generated */  
  public Appendix(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
