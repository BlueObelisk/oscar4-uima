 ...
 * @generated */
public class TextBody extends Text {
  /** @generated
   * @ordered 
   */
  public final static int typeIndexID = JCasRegistry.register(TextBody.class);
  /** @generated
   * @ordered 
   */
   ...
   * @generated */
  public TextBody(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  
  /** @generated */
  public TextBody(JCas jcas) {
    super(jcas);
    readObject();   
  } 

  /** @generated */  
  public TextBody(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
