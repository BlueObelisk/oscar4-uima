 ...
 * @generated */
public class RSQ extends Quotation {
  /** @generated
   * @ordered 
   */
  public final static int typeIndexID = JCasRegistry.register(RSQ.class);
  /** @generated
   * @ordered 
   */
   ...
   * @generated */
  public RSQ(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  
  /** @generated */
  public RSQ(JCas jcas) {
    super(jcas);
    readObject();   
  } 
