 ...
 * @generated */
public class BNF extends SemanticFunctionLabel {
  /** @generated
   * @ordered 
   */
  public final static int typeIndexID = JCasRegistry.register(BNF.class);
  /** @generated
   * @ordered 
   */
   ...
   * @generated */
  public BNF(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  
  /** @generated */
  public BNF(JCas jcas) {
    super(jcas);
    readObject();   
  } 
