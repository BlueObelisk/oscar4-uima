 ...
 * @generated */
public class auxiliary extends StanfordDependencyLabel {
  /** @generated
   * @ordered 
   */
  public final static int typeIndexID = JCasRegistry.register(auxiliary.class);
  /** @generated
   * @ordered 
   */
   ...
   * @generated */
  public auxiliary(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  
  /** @generated */
  public auxiliary(JCas jcas) {
    super(jcas);
    readObject();   
  } 
