 ...
 * @generated */
public class HYPH extends PennPOS {
  /** @generated
   * @ordered 
   */
  public final static int typeIndexID = JCasRegistry.register(HYPH.class);
  /** @generated
   * @ordered 
   */
   ...
   * @generated */
  public HYPH(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  
  /** @generated */
  public HYPH(JCas jcas) {
    super(jcas);
    readObject();   
  } 
