 ...
 * @generated */
public class MNR extends SemanticFunctionLabel {
  /** @generated
   * @ordered 
   */
  public final static int typeIndexID = JCasRegistry.register(MNR.class);
  /** @generated
   * @ordered 
   */
   ...
   * @generated */
  public MNR(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  
  /** @generated */
  public MNR(JCas jcas) {
    super(jcas);
    readObject();   
  } 
