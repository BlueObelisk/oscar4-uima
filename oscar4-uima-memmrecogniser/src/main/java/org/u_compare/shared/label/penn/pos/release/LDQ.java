 ...
 * @generated */
public class LDQ extends Quotation {
  /** @generated
   * @ordered 
   */
  public final static int typeIndexID = JCasRegistry.register(LDQ.class);
  /** @generated
   * @ordered 
   */
   ...
   * @generated */
  public LDQ(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  
  /** @generated */
  public LDQ(JCas jcas) {
    super(jcas);
    readObject();   
  } 
