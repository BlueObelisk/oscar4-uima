 ...
 * @generated */
public class Sign extends PennPOS {
  /** @generated
   * @ordered 
   */
  public final static int typeIndexID = JCasRegistry.register(Sign.class);
  /** @generated
   * @ordered 
   */
   ...
   * @generated */
  public Sign(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  
  /** @generated */
  public Sign(JCas jcas) {
    super(jcas);
    readObject();   
  } 
