...
public class ProperNoun extends Noun {
   ...
   * @ordered 
   */
  public final static int typeIndexID = JCasRegistry.register(ProperNoun.class);
  /** @generated
   * @ordered 
   */
   ...
   * @generated */
  protected ProperNoun() {}
    
  /** Internal - constructor used by generator 
   * @generated */
  public ProperNoun(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  
  /** @generated */
  public ProperNoun(JCas jcas) {
    super(jcas);
    readObject();   
  } 
