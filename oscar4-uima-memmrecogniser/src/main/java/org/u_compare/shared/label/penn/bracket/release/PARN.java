 ...
 * @generated */
public class PARN extends Phrase {
  /** @generated
   * @ordered 
   */
  public final static int typeIndexID = JCasRegistry.register(PARN.class);
  /** @generated
   * @ordered 
   */
   ...
   * @generated */
  public PARN(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  
  /** @generated */
  public PARN(JCas jcas) {
    super(jcas);
    readObject();   
  } 
