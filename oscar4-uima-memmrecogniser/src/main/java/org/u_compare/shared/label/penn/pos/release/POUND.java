 ...
 * @generated */
public class POUND extends Sign {
  /** @generated
   * @ordered 
   */
  public final static int typeIndexID = JCasRegistry.register(POUND.class);
  /** @generated
   * @ordered 
   */
   ...
   * @generated */
  public POUND(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  
  /** @generated */
  public POUND(JCas jcas) {
    super(jcas);
    readObject();   
  } 
