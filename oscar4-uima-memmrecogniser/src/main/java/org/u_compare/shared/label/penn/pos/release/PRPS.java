 ...
 * @generated */
public class PRPS extends Pronoun {
  /** @generated
   * @ordered 
   */
  public final static int typeIndexID = JCasRegistry.register(PRPS.class);
  /** @generated
   * @ordered 
   */
   ...
   * @generated */
  public PRPS(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  
  /** @generated */
  public PRPS(JCas jcas) {
    super(jcas);
    readObject();   
  } 
