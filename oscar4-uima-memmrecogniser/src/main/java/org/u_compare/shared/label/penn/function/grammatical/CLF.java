 ...
 * @generated */
public class CLF extends GrammaticalFunctionLabel {
  /** @generated
   * @ordered 
   */
  public final static int typeIndexID = JCasRegistry.register(CLF.class);
  /** @generated
   * @ordered 
   */
   ...
   * @generated */
  public CLF(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  
  /** @generated */
  public CLF(JCas jcas) {
    super(jcas);
    readObject();   
  } 
