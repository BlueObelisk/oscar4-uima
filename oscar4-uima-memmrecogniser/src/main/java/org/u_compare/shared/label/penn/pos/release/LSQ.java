 ...
 * @generated */
public class LSQ extends Quotation {
  /** @generated
   * @ordered 
   */
  public final static int typeIndexID = JCasRegistry.register(LSQ.class);
  /** @generated
   * @ordered 
   */
   ...
   * @generated */
  public LSQ(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  
  /** @generated */
  public LSQ(JCas jcas) {
    super(jcas);
    readObject();   
  } 
