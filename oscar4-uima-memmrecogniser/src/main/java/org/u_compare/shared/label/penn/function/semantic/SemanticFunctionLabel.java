 ...
 * @generated */
public class SemanticFunctionLabel extends FunctionLabel {
  /** @generated
   * @ordered 
   */
  public final static int typeIndexID = JCasRegistry.register(SemanticFunctionLabel.class);
  /** @generated
   * @ordered 
   */
   ...
   * @generated */
  protected SemanticFunctionLabel() {}
    
  /** Internal - constructor used by generator 
   * @generated */
  public SemanticFunctionLabel(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  
  /** @generated */
  public SemanticFunctionLabel(JCas jcas) {
    super(jcas);
    readObject();   
  } 
