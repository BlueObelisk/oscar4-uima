 ...
 * @generated */
public class PRD extends GrammaticalFunctionLabel {
  /** @generated
   * @ordered 
   */
  public final static int typeIndexID = JCasRegistry.register(PRD.class);
  /** @generated
   * @ordered 
   */
   ...
   * @generated */
  public PRD(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  
  /** @generated */
  public PRD(JCas jcas) {
    super(jcas);
    readObject();   
  } 
