 ...
 * @generated */
public class RDQ extends Quotation {
  /** @generated
   * @ordered 
   */
  public final static int typeIndexID = JCasRegistry.register(RDQ.class);
  /** @generated
   * @ordered 
   */
   ...
   * @generated */
  public RDQ(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  
  /** @generated */
  public RDQ(JCas jcas) {
    super(jcas);
    readObject();   
  } 
