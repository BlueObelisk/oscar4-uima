 ...
 * @generated */
public class Iteration extends TOP {
  /** @generated
   * @ordered 
   */
  public final static int typeIndexID = JCasRegistry.register(Iteration.class);
  /** @generated
   * @ordered 
   */
   ...
   * @generated */
  public Iteration(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  
  /** @generated */
  public Iteration(JCas jcas) {
    super(jcas);
    readObject();   
  } 
